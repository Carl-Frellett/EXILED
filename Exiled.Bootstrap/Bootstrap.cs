    ...
    public sealed class Bootstrap
    {
        ...
        public static void Load()
        {
            ...
            try
            {
                ...
                ServerConsole.AddLog("[Exiled.Bootstrap] Exiled Bootsharp Reboot Code by Carl Frellett", ConsoleColor.DarkRed);
                ...
                if (!File.Exists(Path.Combine(dependenciesPath, "SemanticVersioning.dll")))
                {
                    ServerConsole.AddLog($"[Exiled.Bootstrap] SemanticVersioning.dll was not found, Exiled won't be loaded!", ConsoleColor.DarkRed);
                    return;
                }
                    ...
                    ?.Invoke(
                        ...
                        new object[]
                        {
                            new[]
                            {
                                ...
                                Assembly.Load(File.ReadAllBytes(Path.Combine(dependenciesPath, "SemanticVersioning.dll"))),
                            },
                        });
